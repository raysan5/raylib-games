...
//----------------------------------------------------------------------------------
static const char textFinalForm[32] = "THIS ISN'T EVEN MY FINAL FORM!";
static const char textSpring1[32] = "FLOWER POWER!";
static const char textSummer1[32] = "PREPARE FOR THE SUMMER!";
static const char textFall1[32] = "HERE COMES THE FALL!";
static const char textWinter1[32] = "WINTER IS COMING!";
static const char textSpring2[32] = "POLLEN IS IN THE AIR";
static const char textSummer2[32] = "HAPPY NEW YEAR!";
static const char textFall2[32] = "IT'S RAINING RAIN";
static const char textWinter2[32] = "LET IT SNOW!";

static float gravity = 0.0f;
static SeasonState season = { 0 };
static KoalaState state = { 0 };
static int framesCounter = 0;
static int finishScreen = 0;
static int grabCounter = 0;
static int velocity = 0;
static int speed = 0;
static int bambooTimer = 0;
static int bambooSpawnTime = 0;
static int colorTimer = 0;
static int jumpSpeed = 0;
static int power = 0;
static int maxPower = 0;
static int transCount = 0;
static int posArray[2] = { 0 };
static int posArrayDingo[2] = { 0 };
static int enemyVel[MAX_ENEMIES] = { 0 };
static int beeVelocity = 0;
static int fireSpeed = 0;
static int windCounter = 0;
static int seasonTimer = 0;
static int seasonChange = 0;
static int resinCountjump = 0;
static int resinCountdrag = 0;
static int resinCount = 0;
static int currentMonth = 0;
static int monthTimer = 0;
static int monthChange = 0;
static int initMonth = 0;
static int fireCounter[MAX_FIRE] = { 0 };
static int fireOffset = 0;
static int beeMov = 0;
static int killCounter = 0;
static int leafType[MAX_LEAVES] = { 0 };
static int posArrayLeaf[3] = { 0 };
static int transAniCounter = 0;
static int globalFrameCounter = 0;
static int startCounter = 0;
static int animCounter = 0;
static int finalFormEnd = 0;
static int randomMessage = 0;
static int parallaxBackOffset = 0;
static int parallaxFrontOffset = 0;
static int startNum = 3;                // WARNING: Init to !0
...
static int curFrame1 = 0;
static int curFrame2 = 0;
static int curFrame3 = 0;
static int transitionFramesCounter = 0;
static int thisFrameKoala = 0;
static int curFrameKoala = 0;
static int fogSpeed = 0;
static int fogPosition = 0;
static int progresionDelay = 0;
static int progresionFramesCounter = 0;
static int initLeaves = 0;
static int eagleDelay = 0;

// Stage data variables
static int jumpCounter = 0;
static int resinCounter = 0;
static int tornadoCounter = 0;
static int dashCounter = 0;
static int superKoalaCounter = 0;

// General data variables
static int snakeKillCounter = 0;
static int dingoKillCounter = 0;
static int owlKillCounter = 0;
static int beeKillCounter = 0;
static int eagleKillCounter = 0;
static int globalKillCounter = 0;
static int deathsCounter = 0;

static float scrollFront = 0.0f;
static float scrollMiddle = 0.0f;
static float scrollBack = 0.0f;
static float scrollSpeed = 0.0f;
static float rightAlpha = 0.5f;
static float leftAlpha = 0.5f;
static float speedMod = 0.0f;
static float groundPos = 0.0f;
static float transRotation = 0.0f;
static float clockRotation = 0.0f;
static float clockSpeedRotation = 0.0f;
static float numberAlpha = 0.0f;
static float numberScale = 0.0f;
static float fogAlpha = 0.0f;
static float speedIncrease = 0.0f;
static float speedProgresion = 0.0f;
static float progresionSpawnChance = 0.0f;
static float UIfade = 0.0f;
static float filterAlpha = 0.0f;
static float leafGUIglowFade = 0.0f;
static float leafGUIpulseFade = 0.0f;
static float leafGUIpulseScale = 0.0f;
static float clockInitRotation = 0.0f;
static float clockFinalRotation = 0.0f;

static bool snakeActive[MAX_ENEMIES] = { 0 };
static bool dingoActive[MAX_ENEMIES] = { 0 };
static bool owlActive[MAX_ENEMIES] = { 0 };
static bool branchActive[MAX_ENEMIES] = { 0 };
static bool bambooActive[MAX_BAMBOO] = { 0 };
static bool leafActive[MAX_LEAVES] = { 0 };
static bool fireActive[MAX_FIRE] = { 0 };
static bool iceActive[MAX_ICE] = { 0 };
static bool windActive[MAX_WIND] = { 0 };
static bool resinActive[MAX_RESIN] = { 0 };
static bool isHitSnake[MAX_ENEMIES] = { 0 };
static bool isHitDingo[MAX_ENEMIES] = { 0 };
static bool isHitOwl[MAX_ENEMIES] = { 0 };
static bool isHitBee = false;
static bool isHitEagle = false;
static bool onFire[MAX_FIRE] = { 0 };
static bool onIce = false;
static bool onResin = false;
static bool playerActive = false;
static bool play = false;
static bool transforming = false;
static bool onWind = false;
static bool glowing = false;
static bool beeActive = false;
static bool eagleActive = false;
static bool eagleAlert = false;
static bool alertActive = false;
static bool alertBeeActive = false;
static bool coolDown = false;
static bool leafSide[MAX_LEAVES] = { 0 };
static bool transBackAnim = false;
...
static Rectangle wind[MAX_WIND] = { 0 };
static Rectangle bamboo[MAX_BAMBOO] = { 0 };
static Rectangle snake[MAX_ENEMIES] = { 0 };
static Rectangle dingo[MAX_ENEMIES] = { 0 };
static Rectangle owl[MAX_ENEMIES] = { 0 };
static Rectangle leaf[MAX_LEAVES] = { 0 };
static Rectangle powerBar = { 0 };
static Rectangle backBar = { 0 };
static Rectangle fireAnimation = { 0 };
static Rectangle windAnimation = { 0 };
static Rectangle beeAnimation = { 0 };
static Rectangle snakeAnimation = { 0 };
static Rectangle dingoAnimation = { 0 };
static Rectangle owlAnimation = { 0 };
static Rectangle bee = { 0 };
static Rectangle eagle = { 0 };
static Rectangle eagleAnimation = { 0 };
static Rectangle koalaAnimationIddle = { 0 };
static Rectangle koalaAnimationJump = { 0 };
static Rectangle koalaAnimationFly = { 0 };
static Rectangle koalaAnimationTransform = { 0 };
static Rectangle alertRectangle = { 0 };
static Rectangle beeAlertRectangle = { 0 };

static time_t rawtime = { 0 };
static struct tm *ptm = NULL;

static Color finalColor = { 0 };
static Color finalColor2 = { 0 };
static Color flyColor = { 0 };
static Color counterColor = { 0 };
...
static Vector2 firePos = { 0 };
static Vector2 branchPos[MAX_ENEMIES] = { 0 };
static Vector2 textSize = { 0 };
static Vector2 clockPosition = { 0 };

static Particle enemyHit[MAX_ENEMIES] = { 0 };
static ParticleSystem leafParticles[MAX_LEAVES] = { 0 };
static ParticleSystem snowParticle = { 0 };
static ParticleSystem backSnowParticle = { 0 };
static ParticleSystem dandelionParticle = { 0 };
static ParticleSystem dandelionBackParticle = { 0 };
static ParticleSystem planetreeParticle = { 0 };
static ParticleSystem backPlanetreeParticle = { 0 };
static ParticleSystem flowerParticle = { 0 };
static ParticleSystem backFlowerParticle = { 0 };
static ParticleSystem rainParticle = { 0 };
static ParticleSystem backRainParticle = { 0 };
static ParticleSystemStorm rainStormParticle = { 0 };
static ParticleSystemStorm snowStormParticle = { 0 };
static ParticleSystemRay rayParticles = { 0 };
static ParticleSystemRay backRayParticles = { 0 };
static ParticleSystemSpeed speedFX = { 0 };
static PopUpScore popupScore[MAX_ENEMIES] = { 0 };
static PopUpScore popupLeaves[MAX_LEAVES] = { 0 };
static PopUpScore popupBee = { 0 };
